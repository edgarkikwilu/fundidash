                ...
                <b-card style="width:213px;" class="top-cards-first mt-5 remove-box-shadow">
                    <b-media no-body>
                        ...
                        <b-media-body style="margin-left:-30px">
                            <p class="metric_value ml-5" style="float:left;">17,400</p>
                ...
                <b-card class="remove-box-shadow">
                    <table class="table table-borderless table-inverse table-responsive">
                        <thead class="thead-inverse border-bottom">
                            ...
                            <tbody>
                                <tr class="border-bottom" v-for="fundi in fundis" :key="fundi.id">
                                    <td>
                                        <b-form-checkbox></b-form-checkbox>
                                    </td>
                                    <td>{{fundi.name}}</td>
                                    <td>{{fundi.fundiid}}</td>
                                    <td>{{fundi.nooffundis}}</td>
                                    <td>{{fundi.noofsubcategories}}</td>
                                    <td></td>
                                    <td></td>
                                    <td>
                                        <div class="flex-row flex-nowrap">
                                            <div>
                                                ...
                                                <b-icon @click="onEdit(fundi)" icon="pencil" class="ml-3 cursor-style"></b-icon>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
